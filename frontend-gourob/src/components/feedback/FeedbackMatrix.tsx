 ...
 *
 * Submits to POST /api/feedback on the backend (Render).
 * Lives entirely under src/components/gourob-feedback/ and
 * src/app/feedback-demo/ so it never overlaps with teammates' files.
 */
...
type RatingKey = 'ratingReliability' | 'ratingSafety' | 'ratingEfficiency';
...
const METRICS: { key: RatingKey; label: string; hint: string }[] = [
